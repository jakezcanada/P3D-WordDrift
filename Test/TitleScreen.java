...
/**
 * This is the titlescreen, the player starts with the titlescreen
 * 
 * @author (your name) 
...
public class TitleScreen extends World
{
    ...
    //All buttons on the titlescreen
    ...
    //When the player hovers over a button,the button will change colour
    public void draw(){
    ...
    //Ensures that the player could properly interact with the buttons
    public void act(){
